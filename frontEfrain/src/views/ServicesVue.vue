  ...
  >
    ...
    <div class="grid max-w-md gap-8 row-gap-10 sm:mx-auto lg:max-w-full lg:grid-cols-3">
      <div class="flex flex-col sm:flex-row">
        ...
        <div>
          ...
          <p class="mb-3 text-sm text-gray-900">
            ...
            professional and visually appealing websites.
          </p>
      ...
      <div class="flex flex-col sm:flex-row">
        ...
        <div>
          <h6 class="mb-2 font-semibold leading-5">Social Media Marketing:</h6>
          <p class="mb-3 text-sm text-gray-900">
            Our social media marketing service helps businesses establish a strong online presence
      ...
      <div class="flex flex-col sm:flex-row">
        ...
        <div>
          <h6 class="mb-2 font-semibold leading-5">Content Writing and Copywriting:</h6>
          <p class="mb-3 text-sm text-gray-900">
            Our content writing and copywriting service offers high-quality and engaging content
            that captivates your audience and drives conversions.
          </p>
          <ul class="mb-4 -ml-1 space-y-2">
            <li class="flex items-start">
              <span class="mr-1">
